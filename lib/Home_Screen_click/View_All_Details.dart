...
class _View_DetailsState extends State<View_Details> {
  ...
  Future<List<RealEstateSlider>> fetchCarouselData() async {
    final response = await http.get(Uri.parse('https://verifyserve.social/WebService4.asmx/Show_Image_under_Realestatet?id_num=${_id}'));
        ...
        children: [
          Expanded(
            child: ElevatedButton(
              ...
              child: Text('Image Upload',style: TextStyle(fontSize: 15),),
            ),
          ),
          ...
          Expanded(
            child: ElevatedButton(
              ...
              child: Text('Book Property',style: TextStyle(fontSize: 15)),
            ),
          ),
        ],
      ),
