...
class Catid {
  ...
  factory Catid.FromJson(Map<String, dynamic>json){
    return Catid(
        property_num: json['img']);
  }
}

class FutyureProperty_FileUploadPage extends StatefulWidget {
  String idd;
  FutyureProperty_FileUploadPage({super.key, required this.idd});

  @override
  _FutyureProperty_FileUploadPageState createState() => _FutyureProperty_FileUploadPageState();
}

class _FutyureProperty_FileUploadPageState extends State<FutyureProperty_FileUploadPage> {
...
/*  void _handleButtonClick() async {
  ...
  Future<List<Catid>> fetchData() async {
    var url = Uri.parse("https://verifyserve.social/WebService4.asmx/display_future_property_addimages_by_subid_?subid=${widget.idd}");
  ...
  Future<void> uploadImageWithTitle(File imageFile, String title) async {
    String uploadUrl = 'https://verifyserve.social/PHP_Files/future_property_slider_images/future_property_addimage.php'; // Replace with your API endpoint
  ...
  Future<void> _handleUpload() async {
    ...
    await uploadImageWithTitle(_imageFile!, '${widget.idd}');
  }
                              ...
                              return Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                    "https://verifyserve.social/PHP_Files/future_property_slider_images/${snapshot.data![len].property_num}",
                                    fit: BoxFit.fitWidth,
