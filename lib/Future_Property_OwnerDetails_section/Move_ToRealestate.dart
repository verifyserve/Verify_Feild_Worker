...
class MoveTO_Add_Realestate extends StatefulWidget {
  String type;
  String BHK_;
  String Rent;
  String place;
  ...
  String ownername;
  String ownernumber;
  MoveTO_Add_Realestate({super.key, required this.type, required this.BHK_, required this.Rent, required this.place
    , required this.ADDRESS, required this.info, required this.ownername, required this.ownernumber});

  @override
  _MoveTO_Add_RealestateState createState() => _MoveTO_Add_RealestateState();
}

class _MoveTO_Add_RealestateState extends State<MoveTO_Add_Realestate> {
