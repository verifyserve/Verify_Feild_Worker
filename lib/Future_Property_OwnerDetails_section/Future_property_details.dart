...
import 'Move_ToRealestate.dart';
import 'Move_To_PropertyVerification.dart';
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MoveTO_Add_Realestate(type: '${abc.data![len].tyope}', BHK_: '${abc.data![len].BHK}', Rent: '${abc.data![len].buy_Rent}', place: '${abc.data![len].Building_Location}', ADDRESS: '${abc.data![len].Building_Address}', info: '${abc.data![len].Building_information}', ownername: '${abc.data![len].Ownername}', ownernumber: '${abc.data![len].Owner_number}',))
                              );
                            ...
                            child: Text('Move to Real Estate',style: TextStyle(fontSize: 13)),
                          ),
                        );
                      });
